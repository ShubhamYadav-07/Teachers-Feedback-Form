...
public class Teacher_Feedback_Form extends JFrame
{   
    Teacher_Feedback_Form()
    {
        ...
        // ALL JLabelS
        JLabel nameJLabel = new JLabel("Student's Name : ",JLabel.LEFT);
        JLabel rollNoJLabel = new JLabel("Roll No. : ",JLabel.LEFT);
        JLabel subjectJLabel = new JLabel("Teacher's Name : ",JLabel.LEFT);
        ...
        JLabel eJLabel3 = new JLabel("3. Teacher is Organised and neat : ",JLabel.LEFT);
        ...
        JLabel eJLabel9 = new JLabel("9. Teacher returns homework timely : ",JLabel.LEFT);
        JLabel eJLabel10 = new JLabel("10. Teacher grades Fairly : ",JLabel.LEFT);
        JLabel eJLabel11 = new JLabel("11. You have learned a lot from the teacher about this subject : ",JLabel.LEFT);
        ...
        JLabel eJLabel14 = new JLabel("14. Teacher encourages students to speak up : ",JLabel.LEFT);
        ...
        JLabel iJLabel11 = new JLabel("25. Teacher is consistent and fair in discipline : ",JLabel.LEFT);
        JLabel iJLabel12 = new JLabel("26. I trust this teacher : ",JLabel.LEFT);
        JLabel iJLabel13 = new JLabel("27. Teacher tries to match student's expectations : ",JLabel.LEFT);
        ...
        TextField subjectTextField = new TextField(20);
        ...
        subjectTextField.setBounds(430,40,100,20);
        ...
        {  
            ...
            {  
            	try 
            	{
					FileOutputStream out = new FileOutputStream("FeedBack_Data.txt");
					...
					out.write("\n".getBytes());
					out.write("Teacher's Name : ".getBytes());
					out.write(subjectTextField.getText().getBytes());
					out.write("\n".getBytes());
					...
					out.write("3. Teacher is Organised and neat : ".getBytes());
					...
					out.write("9. Teacher returns homework timely : ".getBytes());
					...
					out.write("11. You have learned a lot from the teacher about this subject : ".getBytes());
					...
					out.write("14. Teacher encourages students to speak up : ".getBytes());
					...
					out.write("18. Teacher accepts responsibility for his/her own mistakes : ".getBytes());
					...
					out.write("25. Teacher is consistent and fair in discipline : ".getBytes());
					...
					out.write("27. Teacher tries to match student's expectations : ".getBytes());
            	...
            	{
					e1.printStackTrace();
                    JOptionPane.showMessageDialog(null, "Error occurred while submitting feedback.", "Error", JOptionPane.ERROR_MESSAGE);
				}            	
            }
    ...
    {
    	Teacher_Feedback_Form ml=new Teacher_Feedback_Form();
        ml.setVisible(true);
        ml.setSize(600,800);
